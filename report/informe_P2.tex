...
tiempo de c\'omputo a $13{,}7$\,s y $25{,}3$\,s respectivamente, a cambio de una mayor
preservaci\'on de la estructura local (\textit{trustworthiness} de $0{,}987$ y $0{,}977$,
frente a $0{,}866$ de PCA). En
...
\midrule
PCA   & $0{,}01$  & $0{,}866$ & Lineal (varianza global) \\
t-SNE & $13{,}69$ & $0{,}987$ & Variedad (estructura local) \\
UMAP  & $25{,}25$ & $0{,}977$ & Variedad (estructura local) \\
\bottomrule
\end{tabular}
\end{table}
...
sugiri\'o $k=2$ grupos para GMM ($s=0{,}182$), valor corroborado por las restantes
...
($0{,}026$ para GMM y $0{,}003$ para DBSCAN) constituyen un hallazgo relevante: la
...
$0{,}464$, mientras que XGBoost obtuvo $0{,}453$, situando a ambos modelos
...
fase no supervisada. La red neuronal super\'o marginalmente al modelo de ensamble.
Un an\'alisis desagregado por clase (Cuadro~\ref{tab:recall}) explica esta ventaja.
El XGBoost concentra su acierto en las clases mayoritarias --recall de $0{,}64$ en la
clase 23 y $0{,}58$ en la 17--, a costa de penalizar severamente a las minoritarias
(recall de apenas $0{,}30$ en la clase 18). El MLP, gracias a la ponderaci\'on de la
p\'erdida, distribuye el acierto de forma m\'as equitativa entre clases (recall entre
$0{,}38$ y $0{,}58$, sin ninguna clase abandonada), lo que eleva su F1-macro por encima
del ensamble pese a una \textit{accuracy} global similar. El error dominante no
se limita a las tres aves: la mayor masa de confusi\'on se produce entre las clases 23
(ave) y 10 (anfibio) en ambos modelos ($47$ casos $23\!\to\!10$ en el MLP y $30$ casos
...
\midrule
MLP     & $0{,}58$ & $0{,}53$ & $0{,}40$ & $0{,}57$ & $0{,}38$ \\
XGBoost & $0{,}36$ & $0{,}36$ & $0{,}58$ & $0{,}30$ & $0{,}64$ \\
\bottomrule
\end{tabular}
\end{table}
...
F1-macro frente al tiempo de inferencia por registro. En este caso el MLP resulta
doblemente preferible: ofrece el mejor F1-macro ($0{,}464$ frente a $0{,}453$) y, a la
vez, el menor tiempo de inferencia ($0{,}693$\,ms por registro, frente a los
$2{,}420$\,ms de XGBoost, unas $3{,}5$ veces m\'as lento). El costo del ensamble se
concentra adem\'as en su fase de entrenamiento. En consecuencia, para el volumen de
registros esperado en un despliegue de monitoreo continuo, el MLP domina el
compromiso rendimiento--latencia y se adopta como modelo de producci\'on.
...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  (alerta verde). Cubri\'o el $4{,}0$\,\% de los registros de prueba (19 de 477),
  con una exactitud de $0{,}789$ en dicha zona.
...
ubicaci\'on de los umbrales. La pol\'itica exhibe un \textbf{compromiso claro entre
cobertura y fiabilidad}: la Zona de Confianza automatiza solo el $4{,}0$\,\% de los
registros, pero en esa fracci\'on la exactitud asciende a $0{,}789$, muy por encima de
la \textit{accuracy} global ($\approx 0{,}46$). Es decir, el umbral $P\geq 0{,}85$
act\'ua como un filtro de alta precisi\'on: sacrifica volumen de automatizaci\'on a
cambio de fiabilidad en lo que efectivamente automatiza. El grueso de las detecciones
($74{,}8$\,\% en la Zona de Incertidumbre) se deriva a auditor\'ia humana y un
$21{,}2$\,\% se descarta como ruido. Dada la criticidad ecol\'ogica de un falso
positivo, la
